  ...
  <body>
    <div class="container">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="email" placeholder="Entrer Email (*)" name="frmEmail" required>
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" id="frmMDP2" placeholder="Confirmer votre mot de passe (*)" name="frmConfirm" required>
        </div>
