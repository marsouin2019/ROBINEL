...
<html lang="en">
  <head>
    ...
    <title>Mon évaluation - ROBINEL MATHIEU</title>
  </head>
  <body>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#">MATHIEU ROBINEL</a>
    ...
    <div class="container">
      ...
      <form method="POST" action="traitement.php" id="frmRegister">
                        ...
                        <div class="form-group">
                            ...
                            <small id="passwordHelp" class="form-text text-muted">Champs obligatoire.</small>
                        </div>
  ...
  <script src="vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="https://localhost/mon-bien-immo.com/traitement.php"></script>
    <script src="https://localhost/mon-bien-immo.com/traitement.js"></script>
